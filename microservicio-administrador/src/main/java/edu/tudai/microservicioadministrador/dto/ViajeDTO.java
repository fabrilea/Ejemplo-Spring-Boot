...
public class ViajeDTO {
    ...
    //Esta clase es útil para transferir datos entre capas de la aplicación
    // (como servicios y controladores) o entre microservicios. Por ejemplo:
    //
    //    Registro de un viaje:
    //        Un controlador puede recibir un objeto ViajeDTO como cuerpo
    //        de una solicitud para registrar un nuevo viaje.
    //
    //    Consulta de detalles:
    //        Al consultar los detalles de un viaje, se puede devolver un
    //        objeto ViajeDTO que incluye datos sobre el monopatín, duración, distancia y pausas.
