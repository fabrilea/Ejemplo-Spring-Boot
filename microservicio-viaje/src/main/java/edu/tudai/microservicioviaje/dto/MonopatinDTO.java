...
public class MonopatinDTO {
    ...
    public MonopatinDTO(Long id, Double bateria, Double latitud, Double longitud,  double kilometrosRecorridos, double tiempoUso, ParadaDTO parada, double tarifaBase, double tarifaExtraPausa) {
        super();
        this.id = id;
